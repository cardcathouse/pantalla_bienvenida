...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFF8000);
  late Color tertiary = const Color(0xFFFFC266);
  late Color alternate = const Color(0xFFFF9933);
  ...
  late Color accent1 = const Color(0xFFFFD699);
  late Color accent2 = const Color(0xFFFFB366);
  late Color accent3 = const Color(0xFFFF9100);
  late Color accent4 = const Color(0xFFFF6600);
  ...
  late Color info = const Color(0xFFFF8000);
}
